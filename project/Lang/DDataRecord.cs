...
namespace Lang
{
    public class DDataRecord : DataRecord<string>
    {
        ...
        private ISet<string> mCategoricalColumns = new HashSet<string>();
        ...
        public void SetCategoricalColumn(string columnName)
        {
            mCategoricalColumns.Add(columnName);
        }
        ...
        public bool IsCategorical(string columnName)
        {
            return mCategoricalColumns.Contains(columnName);
        }
    }
}
